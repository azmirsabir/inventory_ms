<?php
  ...
  class SupplierController extends Controller
  {
    ...
    {
      return SupplierResource::make($this->supplierService->getSupplierById($id));
    }
    ...
    {
      return SupplierResource::make($this->supplierService->updateSupplier($id, $request->validated()));
    }
